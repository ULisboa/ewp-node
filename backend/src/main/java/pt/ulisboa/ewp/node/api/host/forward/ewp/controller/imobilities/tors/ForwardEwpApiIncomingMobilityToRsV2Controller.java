...
public class ForwardEwpApiIncomingMobilityToRsV2Controller extends AbstractForwardEwpApiController {
  ...
  @ForwardEwpApiEndpoint(api = "imobility-tors", apiMajorVersion = 2, endpoint = "specification")
  ...
  @ForwardEwpApiEndpoint(api = "imobility-tors", apiMajorVersion = 2, endpoint = "index")
  @PostMapping(
  ...
  @ForwardEwpApiEndpoint(api = "imobility-tors", apiMajorVersion = 2, endpoint = "get")
  @PostMapping(
      consumes = MediaType.APPLICATION_FORM_URLENCODED_VALUE,
      produces = MediaType.APPLICATION_XML_VALUE,
      value = "/get")
