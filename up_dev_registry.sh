#!/bin/bash
DOCKER_COMPOSE_DEV_OVERRIDE_FILE="docker-compose.dev.registry.override.yml"
...
docker-compose -f docker-compose.dev.registry.yml ${DOCKER_COMPOSE_EXTRA_FLAGS} --env-file .env.dev up -d --build