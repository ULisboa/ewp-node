...
import pt.ulisboa.ewp.node.api.host.forward.ewp.dto.iias.hash.calculation.request.ForwardEwpApiIiaHashesCalculationV4RequestDTO;
...
public class ForwardEwpApiInterInstitutionalAgreementsV4Controller
  ...
  public ResponseEntity<ForwardEwpApiResponseWithData<ForwardEwpApiIiaHashesCalculationResponseDTO>> calculateCooperationConditionsHashes(
      @Valid @RequestBody ForwardEwpApiIiaHashesCalculationV4RequestDTO requestData)
      throws HashCalculationException {
    List<HashCalculationResult> hashCalculationResults = this.hashService.calculateCooperationConditionsHashesForV4(
        requestData.getIias(), EwpApiNamespaces.IIAS_V4_GET_RESPONSE.getNamespaceUrl());
