...
public class EwpClientConstants {
  ...
  public static final String QUERY_IIA_ID = "iia_id";
  public static final String QUERY_IIA_CODE = "iia_code";
  ...
  public static final String QUERY_PARTNER_HEI_ID = "partner_hei_id";
  public static final String QUERY_RECEIVING_ACADEMIC_YEAR_ID = "receiving_academic_year_id";
  public static final String QUERY_SEND_PDF = "send_pdf";
