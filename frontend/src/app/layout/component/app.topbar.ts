...
import { adminAuthActions, AdminAuthState } from '@ewp-node-frontend/shared/states';
...
@Component({
    selector: 'app-topbar',
    standalone: true,
    imports: [MenubarModule, RouterModule, CommonModule, StyleClassModule],
        ...
        <div class="layout-topbar-actions">
            ...
            <div class="layout-topbar-menu hidden lg:block">
                <div class="layout-topbar-menu-content">
                    <ng-container *ngIf="adminAuthState$ | async as adminAuthState">
                        <div class="p-link layout-topbar-text" [style]="{ 'align-content': 'center' }">
                            <span>{{ adminAuthState.user.username }}</span>
                        </div>
                        <button type="button" class="p-link layout-topbar-action" (click)="logout()">
